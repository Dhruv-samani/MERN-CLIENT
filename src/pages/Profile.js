...
const Profile = () => {
  ...
  const { userTour, setUsetTour} = useState();
  ...
  return loading ? (
    ...
    >
      ...
      <MDBRow className="row-cols-1 row-cols-md-3 g-4" style={{marginTop: "-11px"}}>

        <MDBCol>
          <MDBCard className="d-sm-flex" style={{ width: '18rem', height: '31rem' }}>
            <MDBCardImage
              src={
